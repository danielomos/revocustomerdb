package africa.revoenergy.service;
...
import africa.revoenergy.IntegrationTest;
import africa.revoenergy.config.Constants;
import africa.revoenergy.domain.User;
import africa.revoenergy.repository.UserRepository;
import africa.revoenergy.repository.search.UserSearchRepository;
import africa.revoenergy.security.AuthoritiesConstants;
import africa.revoenergy.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the africa.revoenergy.repository.search test package.
     *
     * @see africa.revoenergy.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
